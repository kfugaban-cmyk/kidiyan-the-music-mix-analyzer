  ...
  return (
    <section className="overflow-hidden rounded-[24px] border border-stone-200 bg-white shadow-[0_14px_42px_rgba(72,55,38,0.08)]">
      ...
      <div className="space-y-6 px-5 py-6 sm:px-7">
        ...
        {selectedIntention ? (
          <div className="flex flex-col gap-3 rounded-2xl border border-teal-100 bg-teal-50/60 p-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
            ...
            <button
              ...
              onClick={interpret}
              disabled={isLoading}
              className="inline-flex items-center justify-center gap-2 rounded-full bg-teal-950 px-4 py-2.5 text-xs font-bold text-white shadow-md transition-transform hover:-translate-y-0.5 disabled:cursor-wait disabled:opacity-60"
            >
          ...
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div>
              ...
              {interpretation.claims.map((item, index) => {
                ...
                return (
                  <article key={`${item.title}-${index}`} className="rounded-2xl border border-stone-200 bg-white p-4 shadow-sm sm:p-5">
                    <div className="flex flex-wrap items-center gap-2">
